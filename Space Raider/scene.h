...
private:
    ...
    int timer, timer2=0 ,timer3= 0; //timery do odmierzania czasu w tikach animacji
...
public:
    ...
    int draw(); //draw scene
    void events(sf::Event& event, const sf::Time& elapsed, sf::Clock& clock_shot, int& timer); //sprawdzanie wystêpuj¹cych eventów
